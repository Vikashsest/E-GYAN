  ...
  return (
    ...
    ${selectedChapter?.id === item.id
                    ...
                    >
                      ...
                      {openPartsId === item.id && item.resourceType === "video" && (
                        <div className="mt-2 ml-3 mb-3 bg-gray200 dark:bg-gray700 p-2 rounded">
                          {partsMap[item.id]?.map((part, idx) => (
                            <button
                              key={part.id}
                              onClick={(e) => {
                                e.stopPropagation();
                                ...
                                setSelectedChapter({
                                  ...item,
                                  fileUrl: part.fileUrl, // 🔥 actual video
                                });
                              }}
                              className={`block w-full text-left px-2 py-1 rounded text-xs
          ${idx === 0 ? "font-semibold" : ""}
          bg-gray300 dark:bg-gray600 hover:bg-gray400`}
                            >
                              ▶ Part {idx + 1}
                            </button>
                          ))}
