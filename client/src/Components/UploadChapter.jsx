...
//   // ✅ Add Chapter or Part
//   const handleAddChapter = async (chapterNum = chapterNumber, f = file, t = thumbnail, r = resourceType, vUrl = videoUrl) => {
//     if (!bookId) {
//       toast.error("Invalid book ID");
//       return;
//     }
...
//     //     if (r === "video") {
//     //   fd.append("videoUrl", vUrl);   // ✅ send video link
//     // } else {
//     //   fd.append("file", f);          // ✅ for pdf/audio upload
//     // }
// const fd = new FormData();
// fd.append("chapterNumber", chapterNum);
// fd.append("resourceType", r);
...
// } else {
//   if (f) fd.append("file", f);   // ✅ sirf ek hi baar append hoga
// }
